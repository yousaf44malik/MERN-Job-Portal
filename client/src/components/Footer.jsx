...
const Footer = () => {
  ...
  return (
    <footer className="text-white mp-20 animate__animated animate__fadeIn">
      <div className="overflow-x-hidden -mb-0.5">
        <svg
          className="fill-[#1d4ed8] bg-[#f7fdfd] dark:bg-slate-800"
      ...
      <div className="bg-[#1d4ed8] ">
        ...
        <div className="">
          ...
          <div className="container mx-auto px-5 pt-6 pb-8 flex flex-wrap items-center justify-between ">
            <div className="w-full md:w-2/4 lg:w-1/3 h-16 flex items-center text-black justify-center md:justify-start ">
              <TextInput
