...
const UploadJob = () => {
  ...
  return (
    <div className="w-full dark:bg-slate-800 ">
      <div className="dark:bg-slate-800  container mx-auto flex flex-col md:flex-row gap-8 2xl:gap-14 bg-[#f7fdfd] px-5">
        <div className="dark:bg-slate-700  w-full h-fit md:w-2/3 2xl:2/4 bg-white px-5 py-10 md:px-10 shadow-md">
          <div>
            <p className="text-gray-500 font-semibold text-2xl dark:text-white">
              Job Post
            </p>
            ...
            >
              ...
              <div className="w-full flex gap-4">
                <div className={`w-1/2 mt-2`}>
                  <label className="dark:text-white text-gray-600 text-sm mb-1">
                    Job Type
                  </label>
